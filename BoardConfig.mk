...
TARGET_BOARD_PLATFORM := exynos850               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := SRPTJ12A008     # From ro.product.board
...
BOARD_RECOVERYIMAGE_PARTITION_SIZE := 524288
 BOARD_USES_FULL_RECOVERY_IMAGE := true      # Uncomment this line if you want to remove size restriction
BOARD_FLASH_BLOCK_SIZE := 4294967295                   # Might be different for your chip
...
TW_BRIGHTNESS_PATH := /sys/class/leds/led_r/brightness
...
TARGET_USE_CUSTOM_LUN_FILE_PATH := /sys/class/android_usb/android0(/.*)?          --     u:object_r:sysfs_android_usb:s0
